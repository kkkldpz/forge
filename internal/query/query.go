		...
		case *types.MessageStopEvent:
			...
			if assistantMsg != nil {
				...
				if hasToolUse {
					...
					// 执行工具
					results := tool.ExecuteTools(ctx, toolUses, params.Tools, params.ToolUseContext)
...
func convertToolsToParams(tools []tool.Tool) []api.ToolParam {
...
func detectToolUses(msg *types.Message) []tool.ToolCall {
...
func createToolResultMessage(result tool.ToolCallResult) types.Message {
